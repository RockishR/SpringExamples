...
- please install Engine dependency
    + on page http://server/codenjoy-contest/help
        * you can download zip with dependency
            ...
            - server = codenjoy.com if you play on http://10.245.129.28:8080/codenjoy-contest
        * on this page you can also read game instructions
- register your hero on server http://server/codenjoy-contest/register
- in class .\src\main\java\com\codenjoy\dojo\snake\client\YourSolver.java
...
- in class .\src\main\java\com\codenjoy\dojo\snake\client\Board.java
    + you can add you own methods for work with board
- in test package .\src\test\java\com\codenjoy\dojo\snake\client
